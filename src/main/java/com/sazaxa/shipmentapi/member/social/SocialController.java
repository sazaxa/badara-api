...
public class SocialController {
    ...
    public SocialController(MemberService memberService, RoleService roleService, PasswordEncoder passwordEncoder, AuthenticationManager authenticationManager) {
    ...
    @PostMapping("/check")
    public ResponseEntity oauthCheck(@RequestBody SocialRequestDto request){
        return null;
    }
}
